...
class MyVideo8 extends StatefulWidget {
  @override
  _MyVideo8State createState() => _MyVideo8State();
}

class _MyVideo8State extends State<MyVideo8> {

  final fb = FirebaseDatabase.instance.reference().child("VideoLink8");

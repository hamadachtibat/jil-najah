...
class MyVideo3 extends StatefulWidget {
  @override
  _MyVideo3State createState() => _MyVideo3State();
}

class _MyVideo3State extends State<MyVideo3> {
  bool isteacher=false;

  final fb = FirebaseDatabase.instance.reference().child("VideoLink3");

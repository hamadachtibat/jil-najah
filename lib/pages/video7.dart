...
class MyVideo7 extends StatefulWidget {
  @override
  _MyVideo7State createState() => _MyVideo7State();
}

class _MyVideo7State extends State<MyVideo7> {
  bool isteacher = false ;

  final fb = FirebaseDatabase.instance.reference().child("VideoLink7");

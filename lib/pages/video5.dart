...
class MyVideo5 extends StatefulWidget {
  @override
  _MyVideo5State createState() => _MyVideo5State();
}

class _MyVideo5State extends State<MyVideo5> {
  bool isteacher=false;

  final fb = FirebaseDatabase.instance.reference().child("VideoLink5");

...
class MyVideo2 extends StatefulWidget {
  @override
  _MyVideo2State createState() => _MyVideo2State();
}

class _MyVideo2State extends State<MyVideo2> {

  final fb = FirebaseDatabase.instance.reference().child("VideoLink2");

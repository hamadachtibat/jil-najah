...
class MyVideo9 extends StatefulWidget {
  @override
  _MyVideo9State createState() => _MyVideo9State();
}

class _MyVideo9State extends State<MyVideo9> {
  bool isteacher=false;

  final fb = FirebaseDatabase.instance.reference().child("VideoLink9");

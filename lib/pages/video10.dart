...
class MyVideo10 extends StatefulWidget {
  @override
  _MyVideo10State createState() => _MyVideo10State();
}

class _MyVideo10State extends State<MyVideo10> {

  final fb = FirebaseDatabase.instance.reference().child("VideoLink10");

...
class MyVideo4 extends StatefulWidget {
  @override
  _MyVideo4State createState() => _MyVideo4State();
}

class _MyVideo4State extends State<MyVideo4> {
  bool isteacher=false;

  final fb = FirebaseDatabase.instance.reference().child("VideoLink4");

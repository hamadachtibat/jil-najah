...
class MyVideo6 extends StatefulWidget {
  @override
  _MyVideo6State createState() => _MyVideo6State();
}

class _MyVideo6State extends State<MyVideo6> {
  bool isteacher=false;

  final fb = FirebaseDatabase.instance.reference().child("VideoLink6");

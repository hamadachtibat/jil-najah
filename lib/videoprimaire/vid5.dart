...
class vid5 extends StatefulWidget {
  @override
  _vid5State createState() => _vid5State();
}

class _vid5State extends State<vid5> {

  final fb = FirebaseDatabase.instance.reference().child("Video5");

...
class vid33 extends StatefulWidget {
  @override
  _vid33State createState() => _vid33State();
}

class _vid33State extends State<vid33> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video33");

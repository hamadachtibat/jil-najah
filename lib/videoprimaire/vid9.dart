...
class vid9 extends StatefulWidget {
  @override
  _vid9State createState() => _vid9State();
}

class _vid9State extends State<vid9> {

  final fb = FirebaseDatabase.instance.reference().child("Video9");

...
class vid31 extends StatefulWidget {
  @override
  _vid31State createState() => _vid31State();
}

class _vid31State extends State<vid31> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video31");

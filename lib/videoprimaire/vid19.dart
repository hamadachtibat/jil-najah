...
class vid19 extends StatefulWidget {
  @override
  _vid19State createState() => _vid19State();
}

class _vid19State extends State<vid19> {

  final fb = FirebaseDatabase.instance.reference().child("Video19");

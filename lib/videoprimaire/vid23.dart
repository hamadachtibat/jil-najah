...
class vid23 extends StatefulWidget {
  @override
  _vid23State createState() => _vid23State();
}

class _vid23State extends State<vid23> {

  final fb = FirebaseDatabase.instance.reference().child("Video23");

...
class vid20 extends StatefulWidget {
  @override
  _vid20State createState() => _vid20State();
}

class _vid20State extends State<vid20> {
 bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video20");

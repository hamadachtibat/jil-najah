...
class vid32 extends StatefulWidget {
  @override
  _vid32State createState() => _vid32State();
}

class _vid32State extends State<vid32> {

  final fb = FirebaseDatabase.instance.reference().child("Video32");

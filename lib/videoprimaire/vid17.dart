...
class vid17 extends StatefulWidget {
  @override
  _vid17State createState() => _vid17State();
}

class _vid17State extends State<vid17> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video17");

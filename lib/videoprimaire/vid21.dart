...
class vid21 extends StatefulWidget {
  @override
  _vid21State createState() => _vid21State();
}

class _vid21State extends State<vid21> {

  final fb = FirebaseDatabase.instance.reference().child("Video21");

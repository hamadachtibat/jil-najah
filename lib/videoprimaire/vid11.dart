...
class vid11 extends StatefulWidget {
  @override
  _vid11State createState() => _vid11State();
}

class _vid11State extends State<vid11> {
  bool isteacher = false;

  final fb = FirebaseDatabase.instance.reference().child("Video11");

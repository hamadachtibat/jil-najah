...
class vid7 extends StatefulWidget {
  @override
  _vid7State createState() => _vid7State();
}

class _vid7State extends State<vid7> {

  final fb = FirebaseDatabase.instance.reference().child("Video7");

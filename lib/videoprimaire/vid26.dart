...
class vid26 extends StatefulWidget {
  @override
  _vid26State createState() => _vid26State();
}

class _vid26State extends State<vid26> {

  final fb = FirebaseDatabase.instance.reference().child("Video26");

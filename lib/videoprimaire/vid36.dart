...
class vid36 extends StatefulWidget {
  @override
  _vid36State createState() => _vid36State();
}

class _vid36State extends State<vid36> {
 bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video36");

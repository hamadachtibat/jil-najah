...
class vid8 extends StatefulWidget {
  @override
  _vid8State createState() => _vid8State();
}

class _vid8State extends State<vid8> {

  final fb = FirebaseDatabase.instance.reference().child("Video8");

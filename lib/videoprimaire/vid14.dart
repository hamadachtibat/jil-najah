...
class vid14 extends StatefulWidget {
  @override
  _vid14State createState() => _vid14State();
}

class _vid14State extends State<vid14> {
  bool isteacher=false;

  final fb = FirebaseDatabase.instance.reference().child("Video14");

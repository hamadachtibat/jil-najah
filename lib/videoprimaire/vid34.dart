...
class vid34 extends StatefulWidget {
  @override
  _vid34State createState() => _vid34State();
}

class _vid34State extends State<vid34> {

  final fb = FirebaseDatabase.instance.reference().child("Video34");

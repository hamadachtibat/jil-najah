...
class vid6 extends StatefulWidget {
  @override
  _vid6State createState() => _vid6State();
}

class _vid6State extends State<vid6> {

  final fb = FirebaseDatabase.instance.reference().child("Video6");

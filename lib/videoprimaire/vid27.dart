...
class vid27 extends StatefulWidget {
  @override
  _vid27State createState() => _vid27State();
}

class _vid27State extends State<vid27> {

  final fb = FirebaseDatabase.instance.reference().child("Video27");

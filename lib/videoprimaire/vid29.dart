...
class vid29 extends StatefulWidget {
  @override
  _vid29State createState() => _vid29State();
}

class _vid29State extends State<vid29> {
 bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video29");

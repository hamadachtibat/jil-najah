...
class vid25 extends StatefulWidget {
  @override
  _vid25State createState() => _vid25State();
}

class _vid25State extends State<vid25> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video25");

...
class vid30 extends StatefulWidget {
  @override
  _vid30State createState() => _vid30State();
}

class _vid30State extends State<vid30> {

  final fb = FirebaseDatabase.instance.reference().child("Video30");

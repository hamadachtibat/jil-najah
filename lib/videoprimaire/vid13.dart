...
class vid13 extends StatefulWidget {
  @override
  _vid13State createState() => _vid13State();
}

class _vid13State extends State<vid13> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video13");

...
class vid10 extends StatefulWidget {
  @override
  _vid10State createState() => _vid10State();
}

class _vid10State extends State<vid10> {

  final fb = FirebaseDatabase.instance.reference().child("Video10");

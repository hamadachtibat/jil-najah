...
class vid4 extends StatefulWidget {
  @override
  _vid4State createState() => _vid4State();
}

class _vid4State extends State<vid4> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video4");

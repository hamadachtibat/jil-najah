...
class vid22 extends StatefulWidget {
  @override
  _vid22State createState() => _vid22State();
}

class _vid22State extends State<vid22> {

  final fb = FirebaseDatabase.instance.reference().child("Video22");

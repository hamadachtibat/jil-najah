...
class vid35 extends StatefulWidget {
  @override
  _vid35State createState() => _vid35State();
}

class _vid35State extends State<vid35> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video35");

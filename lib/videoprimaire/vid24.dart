...
class vid24 extends StatefulWidget {
  @override
  _vid24State createState() => _vid24State();
}

class _vid24State extends State<vid24> {
  bool isteacher=false;

  final fb = FirebaseDatabase.instance.reference().child("Video24");

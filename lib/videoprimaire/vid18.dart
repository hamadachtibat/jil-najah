...
class vid18 extends StatefulWidget {
  @override
  _vid18State createState() => _vid18State();
}

class _vid18State extends State<vid18> {
bool isteacher=false;
  final fb = FirebaseDatabase.instance.reference().child("Video18");
